...
namespace
{
    ...
    UnitTest g_test1(g_group, "Basics", [](){
        ...
        CUT_ASSERT.isTrue(pResult == nullptr, "'get' altered the out_value even though it failed!");
        ...
        CUT_ASSERT.isTrue(static_cast<SchemeInteger*>(pResult)->value() == 42, "Wrong type stored in environment!");
    });
